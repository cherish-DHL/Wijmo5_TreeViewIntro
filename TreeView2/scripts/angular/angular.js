...
(function (Q, W, t)
{
        ...
        this.$get = ["$injector", "$interpolate", "$exceptionHandler", "$templateRequest", "$parse", "$controller", "$rootScope", "$document", "$sce", "$animate", "$$sanitizeUri", function (a, b, c, s, M, v, m, F, Z, L, B)
            {
                ...
                function fa(a, d, e, f, g, k, l, p, m)
                {
                        ...
                        w = e.$$element = A(d), K, da, V, fb = f, za, z = 0, Q = a.length; z < Q; z++)
                    {
                        ...
                        if (K.templateUrl)
                            x =
                                !0, Na("template", ma, K, w), ma = K, K.replace && (k = K), B = of(a.splice(z, a.length - z), w, e, g, ka && fb, l, p,
                                {
    ...
    function Ue()
    {
        this.$get = ["$window", "$document", function (b, a)
            {
                var c = {},
                d = aa((/android (\d+)/.exec(z((b.navigator ||
                                    {}
    ...
    function sd(b)
    {
        ...
        d.$setValidity = function (b, e, f)
        {
            e === t ? (d.$pending || (d.$pending = {}
                ...
                ), g(d.$pending, b, f)) : (d.$pending && h(d.$pending, b, f), wd(d.$pending) && (d.$pending = t));
